...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="${ctxStatic}/juhema/css/reviewslist.css?v=20171116" />
    ...
    <body>
		...
		<div class="tour_list_box">
			...
			<div class="tour_faqs_linklist">
				<div id="faqs_link1" class="link_top" ></div>
				<div class="tour_faqs_linklist_title">Do We Need A Chinese Visa ?</div>
			...
			<div class="tour_faqs_linklist">
				<div id="faqs_link2" class="link_top" ></div>
				<div class="tour_faqs_linklist_title">How To Meet The Driver At The Railway Station In Beijing?</div>
				<div class="tour_faqs_linklist_h1">
					<div class="tour_faqs_linklist_circle"></div>
			...
			<div class="tour_faqs_linklist">
				<div id="faqs_link5" class="link_top" ></div>
				<div class="tour_faqs_linklist_title">Is It Safe To Take Taxi In Beijing Or Other Cities ?</div>
				<div class="tour_faqs_linklist_text">
			...
			<div class="tour_faqs_linklist">
				<div id="faqs_link6" class="link_top" ></div>
				...
				<div class="tour_faqs_linklist_text">
					Hilton hotel at the Wangfujing Street<br>
					The Regent Hotel<br>
					Peninsular Hotel<br>
					Marriott  at the Wangfujing Street<br>
					Crown Plaza Hotel at the Wangfujing Street
				</div>
				<div class="tour_faqs_linklist_h1">
					<div class="tour_faqs_linklist_circle"></div>
					4-Star Hotel：
				...
				<div class="tour_faqs_linklist_text">
					Novetal Peace at the Wangfujing street<br>
					Park Plaza<br>
					Novetal Xinqiao at the Chongwenmen<br>
					Kapok Hotel
				</div>
				<div class="tour_faqs_linklist_h1">
					<div class="tour_faqs_linklist_circle"></div>
				...
				<div class="tour_faqs_linklist_text">
					The Imperial Mansion, Beijing Marriott Executive Apartments<br>
				...
				<div class="tour_faqs_linklist_text">
					Beijing Hilton Airport ( 5 star )<br>
					Beijing Langham Place Beijing Capital Airport<br>
					Crowne Plaza Beijing International Airport<br>
					CITIC Hotel Beijing Airport
				</div>
				<a class="backclass" href="#backid">back</a>
			</div>
			<div class="tour_faqs_linklist">
				<div id="faqs_link7" class="link_top" ></div>
			...
			<div class="tour_faqs_linklist">
				<div id="faqs_link8" class="link_top" ></div>
				<div class="tour_faqs_linklist_title">Can We Exchange Money In The Airport? </div>
				<div class="tour_faqs_linklist_text">
					Yes, there’s a Bank of China in the airport, you can exchange the money there. Please note, there are pickpockets in the airport, please be careful if you want to exchange the money in the airport then! The exchange rate at the airport will be slight lower than that in the bank.<br>
			...
			<div class="tour_faqs_linklist">
				<div id="faqs_link9" class="link_top" ></div>
				<div class="tour_faqs_linklist_title">Do We Have The Same Guide And Driver Through The Whole Trip ?</div>
				<div class="tour_faqs_linklist_text">
					Normally, I will arrange the same tour guide for your stay in one city but if you book the tour at the last minutes or during the tourist season ,maybe we’ll arrange 2 different tour guide for you according to your request .<br>
			...
			<div class="tour_faqs_linklist">
				<div id="faqs_link10" class="link_top" ></div>
				<div class="tour_faqs_linklist_title">How Much Time Do We Need To Be The Airport For The International Flight Or Domestic Flight ?</div>
				<div class="tour_faqs_linklist_text">
			...
			<div class="tour_faqs_linklist">
				<div id="faqs_link11" class="link_top" ></div>
				<div class="tour_faqs_linklist_title">How Can I Book And Cancel The Tour ？</div>
				<div class="tour_faqs_linklist_text">
					If you like the sample itinerary shown exactly on our website then you can click book and fill the necessary booking information and pay for the deposit respectively. If we need to book the domestic flight or train tickets for your guys, some deposit will be required, you can pay by paypal or credit card.<br>
					If some emergency happens, then you have to cancel the trip with us and if it’s one week before the trip. Due to we will not require you any prepaid for arranging the tour guide and driver for you in advance, so please inform us as soon as possible, then we are able to arrange new tour for our guide and driver. We will appreciate your cooperation very much.
				</div>
				<a class="backclass" href="#backid">back</a>
			</div>
		</div>
		<div id="tour_reviews_id" class="tour_reviewslist_bg">
			<div class="public_title">Didn't find what you were searching for?</div>
			
			<div class="tour_list_box">
			</div>
			<button onclick="javascript:window.location.href='/advice'" class="buttonpublic_nochange buttoncolor3 viewallreviews">Go To Contact Us</button>
			<div>&nbsp;</div>
		</div>
		...
		<script type="text/javascript" src="${ctxStatic}/juhema/js/jquery-1.11.0.js?v=20171116" ></script>
