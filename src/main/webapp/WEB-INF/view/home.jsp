...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="${ctxStatic}/juhema/css/step.css?v=20171116" />
		...
		<link rel="stylesheet" href="${ctxStatic}/juhema/css/slider.css?v=20171116" />
		<style>
			.tour_top{
	...
	<body>
		...
		<div class="homepic_box">
			...
			<div class="tour_slider_title_text">We are committed to offering travel services of the highest quality, combining our energy and enthusiasm, with our years of experience.</div>
			<button class="buttonpublic buttoncolor2 button_slider_bottom" onclick="javascript:window.location.href='/advice'">
				CONTACT US
			</button>
		</div>
		<footer class="tour_foot_bg tour_foot_bg_home">
			...
			<script type="text/javascript" src="${ctxStatic}/juhema/js/lbx_slider.js?v=20171116" ></script>
