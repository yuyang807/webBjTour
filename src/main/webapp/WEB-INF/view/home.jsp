...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="${ctxStatic}/juhema/css/step.css?v=20171112" />
		...
		<link rel="stylesheet" href="${ctxStatic}/juhema/css/slider.css?v=20171112" />
		<style>
			.tour_top{
	...
	<body>
		...
		<footer class="tour_foot_bg tour_foot_bg_home">
			...
			<script type="text/javascript" src="${ctxStatic}/juhema/js/lbx_slider.js?v=20171112" ></script>
			...
			<script type="text/javascript" src="${ctxStatic}/juhema/js/tourlist.js?v=20171112" ></script>
			<script>
