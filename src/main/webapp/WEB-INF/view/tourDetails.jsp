...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="${ctxStatic}/juhema/css/details.css?v=20171116" />
		<link rel="stylesheet" href="${ctxStatic}/juhema/css/guide.css?v=20171116" />
		<link rel="stylesheet" href="${ctxStatic}/juhema/css/pikaday.css?v=20171116" />
		<link rel="stylesheet" href="${ctxStatic}/juhema/css/slider2.css?v=20171116" />
	</head>
    <body>
...
6. Our tours are complete non-forced shopping tour and we won’t take you to any factories without request to waste your valuable time.
		...
		<script type="text/javascript" src="${ctxStatic}/juhema/js/pikaday.js?v=20171116" ></script>
		<script type="text/javascript" src="${ctxStatic}/juhema/js/lbx_slider_new.js?v=20171116" ></script>
		<script>
			/*var datalist = [
				{
					"name":"page1",
