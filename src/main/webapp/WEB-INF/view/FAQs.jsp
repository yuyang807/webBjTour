...
<html lang="en">
    ...
    <body>
		...
		<div id="tour_reviews_id" class="tour_reviewslist_bg">
			...
			<button class="buttonpublic_nochange buttoncolor3 viewallreviews">Go To Contact Us</button>
			<div>&nbsp;</div>
		</div>
		...
		<script type="text/javascript" src="${ctxStatic}/juhema/js/jquery-1.11.0.js?v=20170316" ></script>
